"""Mini reproduction of "Attention Is All You Need" with a residual ablation.
...
It compares the standard residual + layer norm structure with an ablated model
that removes residual connections from encoder and decoder sublayers.

Run:
    python transformer_ablation.py --quick
    python transformer_ablation.py --steps 400 --layers 4
"""
